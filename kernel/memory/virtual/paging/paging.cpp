...
void handle_read_write_flag(const PagingFlags flags, PageTableEntry* pt3_PTI) {
...
void handle_cache_disable_flag(const PagingFlags flags, PageTableEntry* pt3_PTI) {
